...
exports.StackProvider = exports.StackContext = void 0;
...
exports.StackContext = Context;
var StackProvider = function StackProvider(_ref) {
  var children = _ref.children,
    selectedValue = _ref.selectedValue,
    onChange = _ref.onChange,
    displayButtons = _ref.displayButtons,
    error = _ref.error,
  ...
  var handleSetValue = (0, _react.useCallback)(function (value) {
    setValue(value);
    if (onChange) {
      onChange({
        selectedValue: value
